...
function _omb_theme_PROMPT_COMMAND() {
  PS1="\n$(_omb_prompt_print_python_venv)${icon_user}${_omb_prompt_bold_brown}${user_name^^f}${_omb_prompt_normal} @ ${_omb_prompt_bold_teal}\h${_omb_prompt_normal} in ${_omb_prompt_bold_purple}\W |${_omb_prompt_normal}${_omb_prompt_yellow}\$([[ -n \$(_omb_prompt_git branch 2> /dev/null) ]] && echo \" on Branch \")${icon_branch}${_omb_prompt_white}$(scm_prompt_info)${_omb_prompt_normal} $ "
  PS2="${icon_end}"
}
