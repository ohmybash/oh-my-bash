...
function __powerline_prompt_command {
  ...
  [[ "${last_status}" -ne 0 ]] && __powerline_left_segment $(__powerline_last_status_prompt ${last_status}) || __powerline_left_segment $(__powerline_last_status_prompt ${last_status})
