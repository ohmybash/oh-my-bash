...
A derivated of "agnoster" with customization for multiple lines, datetime, kube context.
Also a bit more compact, removing some spaces in the agnoster prompt
